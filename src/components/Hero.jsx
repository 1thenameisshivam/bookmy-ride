      ...
      <div className="mb-2 flex flex-col items-center justify-center gap-3">
        <div className="text-normal flex flex-col items-center justify-center p-5 font-bold sm:text-xl md:text-2xl">
          ...
          <div className="flex  items-center justify-center gap-1 ">
            <span className="text-gray-400 text-2xl">Embark on</span>
        ...
        <button className="cursor-pointer text-white rounded-3xl bg-red-600 px-4 py-2 font-mono tracking-tighter hover:bg-red-700">
          Begin your journey
        </button>
      </div>
    </div>
