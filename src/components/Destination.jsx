            ...
            <div className="flex w-full flex-wrap items-center justify-center">
                ...
                >
                    <div className="p-2">
                        ...
                        <p className="leading-2 text-sm text-muted-foreground">
                            Visit the sacred temple of Khatushyam in Rajasthan,
                            known for its spiritual significance and the
                            devotion of Lord Shyam's followers.
                        </p>
                    </div>
                </TiltedCover>
                ...
                >
                    <div className="p-2 ">
                        ...
                        <p className="leading-2 text-sm text-muted-foreground">
                            ...
                            cultural experiences, we offer rides to a wide range
                            of popular spots across the city and beyond.
                        </p>
                    </div>
                </TiltedCover>
                ...
                >
                    <div className="p-2">
                        ...
                        <p className="leading-2 text-sm text-muted-foreground">
                            Embark on a spiritual journey to the revered Vaishno
                            Devi shrine nestled in the breathtaking mountains of
                            Jammu and Kashmir.
                        </p>
                    </div>
                </TiltedCover>
